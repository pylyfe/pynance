# What will be the likely performance of an investment if the economy 
# "booms", "normalizes", or "recesses"?
...
#  a function that takes a float and converts it into a percentage
def percentage (number):
    return str(round(number, 4) * 100) + '%'

#  print all the variables as a percentage
...
print('Standard Deviation of Investment 2 = {}'.format(percentage(std2)))
print('Correlation between Returns of 1 & 2 = {}'.format(round(corr, 4)))
print('Risk of Portfolio = {}'.format(percentage(portfolio_vols)))